...
from harness.history import _extract_tool_digest_lines, _flatten_exchanges, _trim_history
...
# already capped to MAX_TOOL_DIGEST_LINES (harness/history.py) with an
# omitted-count marker — never raw tool-call steps beyond that cap. Dies with
# the gateway; restarting it is how you wipe memory.
HISTORY = {}
